...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/delicate-mud-ea10)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/delicate-mud-ea10
```

A live public deployment of this template is available at [https://delicate-mud-ea10.templates.workers.dev](https://delicate-mud-ea10.templates.workers.dev)
